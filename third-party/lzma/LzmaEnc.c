...
static void WriteEndMarker(CLzmaEnc *p, UInt32 posState)
{
  ...
  RcTree_Encode(&p->rc, p->posSlotEncoder[GetLenToPosState(len)], kNumPosSlotBits, (1 << kNumPosSlotBits) - 1); //-V547
